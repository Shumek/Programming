...
$r=mysql_query("select id, city, msg, rad from mes where id=$id") OR DIE(mysql_error());
...
<table align=center><a href="gb.php">На глвную</a><tr><td>
<table>
<tr>

<th>Город:</th>
<td><input class=e name=city value='<?=$city?>'></td></tr>
<tr>
<b>Сообщение:</b><br>
